    ...
    <>
      <main >
        <div className={clsx({ hidden: pathname !== "/" })}>
          <Video />
          <h1 className="text-4xl  text-blue-800 p-10 text-center mt-60">Creamos juntos tu sociedad</h1>
          <h2 className="text-xl  text-blue-500 p-4 text-center mb-16">"Aplicamos una técnica de asesoramiento integral que protege tu negocio hoy y lo prepara para crecer mañana"</h2>
