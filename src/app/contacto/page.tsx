      ...
      <section className="mb-8">
        <form className="max-w-md mx-auto" onSubmit={sendEmail}>
          ...
          <div className="flex items-start mb-4">
            ...
            >
              Acepto la <a href="/politicaDePrivacidad" className="text-blue-600 hover:underline dark:text-blue-500">Política de Privacidad</a> y los <a href="/terminosYCondiciones" className="text-blue-600 hover:underline dark:text-blue-500">Términos y Condiciones</a>.
            </label>
          </div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            La información proporcionada será utilizada únicamente para responder a su consulta. Consulte nuestra <a href="/politica-de-privacidad" className="text-blue-600 hover:underline dark:text-blue-500">Política de Privacidad</a> para más detalles.
          </p>
        </form>
      </section>
    </main>
