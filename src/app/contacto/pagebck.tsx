          ...
          <form className="max-w-md mx-auto" onSubmit={sendEmail}>
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label htmlFor="floating_company" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Compañía</label>
              </div>
            </div>
            <div className="relative z-0 w-full mb-5 group">
              <textarea
                ...
                name="message"
                rows={4}
                className={`block p-2.5 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-blue-900 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ${messageFocused || document.getElementById("message")?.value ? 'pt-6' : ''}`}
                placeholder=" "
                onFocus={() => setMessageFocused(true)}
                onBlur={() => setMessageFocused(!!document.getElementById("message")?.value)}
              ></textarea>
              <label
                htmlFor="message"
